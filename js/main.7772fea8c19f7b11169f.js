...
var translations = {
  en: {
    ...
    workHistoryLastTitle: "Serviceman",
    workHistoryLastLocation: "Army, Tambov, Russia",
    workHistoryPosition: " Instructor for exploitation of radio-electronic equipment",
    education: "Education",
    educationDiploma: "High School Diploma",
    educationUniversity: "Military Aviation Engineering University - Voronezh",
  ...
  ru: {
    ...
    workHistory: "Работа",
    workHistoryLastTitle: "Служащий",
    workHistoryLastLocation: "Армия, Тамбов, Россия",
    workHistoryPosition: "Инструктор по эксплуатации радиоэлектронного оборудования",
    education: "Образование",
    educationDiploma: "Высшее",
    educationUniversity: "Военный авиационный инженерный университет - Воронеж",
