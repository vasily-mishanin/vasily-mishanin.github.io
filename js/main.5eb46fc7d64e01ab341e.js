...
var translations = {
  en: {
    ...
    educationUniversity: 'Voronezh Institute of Radio-electronics',
    certifications: 'Certifications',
    hobbiesTitle: 'Hobbies',
    hobbiesText: 'XC biking, hiking, yoga',
    contact: 'Contact',
    locationA: 'Voronezh, VRN, 394000',
    locationB: 'Bishkek, 720000',
    skills: 'Skills',
    languages: 'Languages'
  },
  ru: {
    ...
    professionalSummaryText: 'Самостоятельно осваиваю фронтенд-разработку, ищу реальный опыт в качестве трейни/джуниора. Помимо технических, обладаю хорошими навыками межличностного общения и расстановки приоритетов. Стремлюсь создавать новое, разрабатывать нужные и удобные продукты для всех людей.',
    workHistory: 'Бекграунд',
    workHistoryLastTitle: 'Радиоинженер',
    workHistoryLastLocation: 'Россия',
    workHistoryPosition: '',
    ...
    contact: 'Контакты',
    locationA: 'Воронеж, VRN, 394000',
    locationB: 'Бишкек, 720000',
    skills: 'Навыки',
    languages: 'Языки'
  }
};
